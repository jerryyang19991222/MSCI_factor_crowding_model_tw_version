...
| 一級因子       | 二級因子                                                                                                                                         | 合成方式               |
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| 成長因子       | 高成長(YOY)、高成長(MOM)、高成長(累計)、盈餘調升                                                                                                 | 模截面 rank 標準化<br>等權重合成 |
| 價值因子       | 低本益比                                                                                                                                         |模截面 rank 標準化<br>等權重合                 |
| 公司治理因子   | 高董監持股                                                                                                                                       |模截面 rank 標準化<br>等權重合                      |
| 動能因子       | 強勢股(日)、強勢股(周)、強勢股(月)、強勢股(季)、高乖離(+)、高乖離(-)                                                                             |模截面 rank 標準化<br>等權重合                       |
| 品質因子       | 高 ROE、高毛利、高殖利率、高配股、高現金股利、高 EPS                                                                                             |模截面 rank 標準化<br>等權重合                        |
| 規模因子       | 高市值、高股價                                                                                                                                   |模截面 rank 標準化<br>等權重合                        |
| 三大法人因子   | 外資買超(日)、外資買超(周)、外資買超(月)、投信買超(日)、投信買超(周)、投信買超(月)、<br>自營買超(日)、自營買超(周)、自營買超(月)、<br>法人買超(日)、法人買超(周)、法人買超(月) | 模截面 rank 標準化<br>等權重合成 |
| 流動性因子     | 高週轉、熱門股成交金額(日)、熱門股成交金額(周)、熱門股成交金額(月)、熱門股成交金額(季)                                                           |模截面 rank 標準化<br>等權重合                        |
| 融資券因子     | 高融資、高融券、高券資比、融資增(日)、融資增(周)、融資增(月)、融券增(日)、融券增(周)、融券增(月)                                                 |模截面 rank 標準化<br>等權重合                        |
| 主題因子       | 外資概念、投信概念、自營概念、法人概念、大陸概念、大陸收成概念                                                                                   |模截面 rank 標準化<br>等權重合                        |

本次驗證因子擁擠模型是否有效乃參考原始研究報告(如下表)，惟本研究於相關性檢定與未來月平均檢定中另外新增因子擁擠指標與未來n日夏普比率之相關係數，用以衡量因子產生報酬之效率。

| 指標名稱 | 定義 |
|----------|------|
| **因子收益率** | 五分位因子等權重多空投資組合報酬率。 |
| **未來報酬相關性檢定** | 各面向因子擷取程度與未來因子報酬率之相關性。 |
| **未來波動度相關性檢定** | 各面向因子擷取程度與未來因子報酬率波動度之相關性。 |
| **未來夏普比率相關性檢定** | 各面向因子擷取程度與未來因子報酬率夏普比例之相關性。 |
| **因子分類** | 綜合因子擷取打分：非擷取(< -0.5)、中性(-0.5～0.5)、擷取(> 0.5)。 |
| **最大回測機率檢定** | 未來一年因子收益率在不同綜合因子擷取打分區間下出現超過5%回撤之機率。 |
| **月平均報酬檢定** | 各種分類因子在未來兩年之平均月因子報酬。 |
| **月平均波動檢定** | 各種分類因子在未來兩年之平均月因子報酬波動度。 |
| **月平均夏普檢定** | 各種分類因子在未來兩年之平均月因子報酬夏普比例。 |
...
![估值價差_return](image/估值價差_return.png)
![估值價差_vol](image/估值價差_vol.png)
![估值價差_sharpe](image/估值價差_sharpe.png)
...
![成對相關係數_return](image/成對相關係數_return.png)
![成對相關係數_vol](image/成對相關係數_vol.png)
![成對相關係數_sharpe](image/成對相關係數_sharpe.png)

由上圖我們可以發現成對相關係數指標與因子未來收益率除了價值因子外皆有相當程度的正相關，而與因子未來收益率波動度之相關性則有相當程度之正相關。顯示成對相關係數對因子未來收益不具有良好的負向預測能力，然而對於未來波動則具有良好的正向預測能力。

## 3. 放空未平倉量（Short Interest Spread）
...
![放空未平倉量_return](image/放空未平倉量_return.png)
![放空未平倉量_vol](image/放空未平倉量_vol.png)
![放空未平倉量_sharpe](image/放空未平倉量_sharpe.png)
...
![因子波動度_return](image/因子波動度_return.png)
![因子波動度_vol](image/因子波動度_vol.png)
![因子波動度_sharpe](image/因子波動度_sharpe.png)
...
![因子長期反轉_return](image/因子長期反轉_return.png)
![因子長期反轉_vol](image/因子長期反轉_vol.png)
![因子長期反轉_sharpe](image/因子長期反轉_sharpe.png)
...
![綜合擁擠指標_return](image/綜合擁擠指標_return_corr.png)
![綜合擁擠指標_vol](image/綜合擁擠指標_vol_corr.png)
![綜合擁擠指標_sharpe](image/綜合擁擠指標_sharpe_corr.png)
